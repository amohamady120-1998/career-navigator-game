...
const MAJOR_LABELS: Record<string, string> = {
  ...
  'LAW_001': 'القانون', 'BUS_001': 'إدارة الأعمال', 'FIN_001': 'المالية والاستثمار',
  'HR_001': 'الموارد البشرية', 'MKT_001': 'التسويق الرقمي', 'MEDIA_001': 'الإعلام',
  'PSY_001': 'علم النفس', 'TRANS_001': 'الترجمة', 'ART_001': 'التصميم والفنون',
};
...
export default function ReportStep() {
  ...
  return (
    ...
    >
      ...
      {/* Explainer Video */}
      <CourseVideo
        title="كيف تقرأ تقريرك الشامل؟"
        description="دليلك لفهم نتيجة هولاند، وكيف يحلل الذكاء الاصطناعي شخصيتك المهنية."
        videoUrl=""
        className="mb-2"
      />
